...
mod GAToken {
    ...
    #[external(v0)]
    impl GATokenContract of super::IGAToken<ContractState> {
        fn name(self: @ContractState) -> felt252 {
            self._name.read()
        }
        fn symbol(self: @ContractState) -> felt252 {
        ...
        fn balanceOf(self: @ContractState, account: ContractAddress) -> u256 {
            GATokenContract::balance_of(self, account)
        }
        fn transferFrom(
            ref self: ContractState,
            sender: ContractAddress,
            ...
            GATokenContract::transfer_from(ref self, sender, recipient, amount)
        }
        fn increase_allowance(
            ref self: ContractState, spender: ContractAddress, added_value: u256
        ) -> bool {
        ...
        fn increaseAllowance(
            ...
            GATokenContract::increase_allowance(ref self, spender, addedValue)
        }
        fn decrease_allowance(
            ref self: ContractState, spender: ContractAddress, subtracted_value: u256
        ) -> bool {
        ...
        fn decreaseAllowance(
            ...
            GATokenContract::decrease_allowance(ref self, spender, subtractedValue)
        }
        fn bridge_to_l1(ref self: ContractState, recipient: felt252, amount: u256) -> bool {
